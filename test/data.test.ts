import { ChainId, WETH, Token, Fetcher, LiquidityProvider } from '../src';
...
describe.skip('data', () => {
  ...
  it('Pair', async () => {
    ...
    const pair = await Fetcher.fetchPairData(WETH[ChainId.RINKEBY], token, LiquidityProvider.UNISWAP);
